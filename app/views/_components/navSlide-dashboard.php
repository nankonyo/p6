...
<div class="fixed-top z-1">
    <div class="d-block d-sm-block d-md-block d-lg-none position-relative bg-body-tertiary" id="slideNavWrapper">
        ...
        <ul class="nav custom-nav-tabs w-100 overflow-auto flex-nowrap d-flex" id="slideNav">
            ...
            <li class="nav-item"><a class="nav-link" href="#">Halaman</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Pengguna</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Akses Pengguna</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Group Staff</a></li>
            <li class="nav-item"><a class="nav-link" href="#">Akses Group Staff</a></li>
